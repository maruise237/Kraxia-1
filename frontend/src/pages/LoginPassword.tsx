    ...
    <div className="flex min-h-screen items-center justify-center bg-dark-bg">
      <div className="w-full max-w-md rounded-xl border border-dark-border bg-dark-card p-6">
        ...
        <div className="mb-6 flex flex-col items-center gap-2">
          ...
          />
          <h1 className="text-lg font-semibold text-dark-text">MedClaw Assistant médical intelligent</h1>
          <p className="text-sm text-dark-muted">Connexion par mot de passe</p>
        </div>
